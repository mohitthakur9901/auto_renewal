...
export default function HeroSection() {
  ...
  <div className="max-w-2xl text-center">
    <h1 className="text-balance text-5xl font-medium md:text-6xl xl:text-7xl">
      Simplify Memberships. Automate Payments.
    </h1>
    <p className="mt-8 text-pretty text-lg">
      A powerful platform to manage your members, send payment reminders, and automate recurring subscriptions — all in one place.
    </p>
    ...
    <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row">
      ...
      <Button variant="ghost" asChild size="lg" className="px-5 text-base">
        <Link href="#demo">
