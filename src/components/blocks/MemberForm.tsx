...
function MemberForm({ member, onChange, onSubmit, onDateChange }: MemberFormProps) {
    const form = useForm({
        defaultValues: {
            name: member.name,
            email: member.email,
    ...
    return (
        <Form {...form}>
            ...
            >
                <h2 className="text-3xl font-bold text-gray-900">Edit Member Details</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <FormField
                        ...
                        render={() => (
                            <FormItem>
                                <FormLabel className="text-sm font-medium text-gray-700">Joining Date</FormLabel>
                                <FormControl>
