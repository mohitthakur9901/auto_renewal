        ...
        <div className="p-4">
            <Table>
                ...
                <TableBody>
                    {visibleMembers.map((member) => (
                        <TableRow key={member.id}>
                            ...
                            <TableCell className="max-w-[120px] truncate">{member.email}</TableCell>
                            <TableCell>{member.phone}</TableCell>
                            <TableCell className="max-w-[100px] truncate">{member.address}</TableCell>
                ...
                <TableFooter>
                    <TableRow>
                        <TableCell colSpan={9}>
                            Total: {visibleMembers.length} member{visibleMembers.length !== 1 ? 's' : ''}
                        </TableCell>
                    </TableRow>
                </TableFooter>
            </Table>
